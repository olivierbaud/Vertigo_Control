    ...
    return (
      <div className="p-8">
        <div className="bg-white rounded-lg shadow p-12 text-center">
          <h3 className="text-lg font-medium text-gray-900">Controller not found</h3>
    ...
    <div className="p-8">
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">{controller.name}</h1>
      ...
      <div>
        ...
        {activeTab === 'scenes' && (
          <div className="bg-white rounded-lg shadow p-12 text-center">
            ...
            <h3 className="mt-4 text-lg font-medium text-gray-900">Scene Management</h3>
        ...
        {activeTab === 'ai' && (
          <div className="bg-white rounded-lg shadow p-12 text-center">
            ...
            <h3 className="mt-4 text-lg font-medium text-gray-900">AI-Powered GUI Design</h3>
            <p className="mt-2 text-sm text-gray-500">
