  ...
  return (
    <div className="p-8 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 min-h-full">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400 mt-2">Overview of your AV control system</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-none p-6 border dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-2">{stats.totalProjects}</p>
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-none p-6 border dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Total Controllers</p>
              <p className="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-2">{stats.totalControllers}</p>
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-none p-6 border dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Online Controllers</p>
              <p className="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-2">{stats.onlineControllers}</p>
            </div>
      ...
      {/* Recent Projects */}
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-none border dark:border-gray-700">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    {project.customer_name && (
                      <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">{project.customer_name}</p>
                    )}
                    {project.location && (
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
        <Link
          to="/projects"
          className="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-none p-6 hover:shadow-lg dark:hover:shadow-xl transition-shadow border dark:border-gray-700"
        >
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Start a new AV control project</p>
            </div>
          </div>
        </Link>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-none p-6 border dark:border-gray-700">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Learn how to use the system</p>
            </div>
          </div>
        </div>
      </div>
