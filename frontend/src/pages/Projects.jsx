...
const Projects = () => {
  ...
  const handleCreate = async (e) => {
    ...
    try {
      ...
      setFormData({ name: '', customer_name: '', location: '' });
      fetchProjects();
    } catch (error) {
    ...
    <div className="p-8 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 min-h-full">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">Manage your AV control projects</p>
        </div>
        <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project) => (
            <Link
              ...
              className="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-none hover:shadow-lg dark:hover:shadow-xl transition-shadow p-6 border dark:border-gray-700"
            >
              ...
              {project.customer_name && (
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">
                  <span className="font-medium">Customer:</span> {project.customer_name}
                </p>
              )}
              {project.location && (
            ...
            <form onSubmit={handleCreate} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Conference Room System"
                />
              </div>
