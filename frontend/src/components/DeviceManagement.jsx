    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage physical devices connected to this controller</p>
        </div>
        <button
      ...
      {devices.length === 0 ? (
        <div className="bg-white rounded-lg shadow p-12 text-center">
          ...
          <h3 className="mt-4 text-lg font-medium text-gray-900">No devices yet</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {devices.map((device) => (
            <div key={device.id} className="bg-white rounded-lg shadow hover:shadow-lg transition-shadow p-6">
              ...
              <div className="space-y-2">
                ...
                {device.connection_config?.host && (
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-mono text-gray-900">{device.connection_config.host}:{device.connection_config.port}</span>
                  </div>
                )}
                <div className="flex items-center justify-between text-sm">
            ...
            <form onSubmit={handleAddDevice} className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Device ID * <span className="text-gray-500 font-normal">(unique identifier)</span>
                </label>
                <input
                  type="text"
                  required
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-lg w-full p-6">
            ...
            <form onSubmit={handleUpdateDevice} className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Device ID <span className="text-gray-500 font-normal">(cannot be changed)</span>
                </label>
                <input
                  type="text"
                  disabled
